...
CREATE TABLE IF NOT EXISTS `validation_manager`.`test_case` (
  ...
  `name` VARCHAR(255) NOT NULL DEFAULT '\"TODO\"',
  ...
  `expected_results` LONGBLOB NULL,
...
CREATE TABLE IF NOT EXISTS `validation_manager`.`requirement` (
  ...
  `mid_version` INT NOT NULL DEFAULT 0,
  `minor_version` INT NOT NULL DEFAULT 1,
  ...
  PRIMARY KEY (`id`, `major_version`, `mid_version`, `minor_version`),
...
CREATE TABLE IF NOT EXISTS `validation_manager`.`step_has_requirement` (
  ...
  `requirement_major_version` INT NOT NULL,
  `requirement_mid_version` INT NOT NULL,
  `requirement_minor_version` INT NOT NULL,
  PRIMARY KEY (`step_id`, `step_test_case_id`, `step_test_case_test_id`, `requirement_id`, `requirement_major_version`, `requirement_mid_version`, `requirement_minor_version`),
  INDEX `fk_step_has_requirement_step1_idx` (`step_id` ASC, `step_test_case_id` ASC, `step_test_case_test_id` ASC),
  INDEX `fk_step_has_requirement_requirement1_idx` (`requirement_id` ASC, `requirement_major_version` ASC, `requirement_mid_version` ASC, `requirement_minor_version` ASC),
  ...
  CONSTRAINT `fk_step_has_requirement_requirement1`
    ...
    REFERENCES `validation_manager`.`requirement` (`id` , `major_version` , `mid_version` , `minor_version`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `validation_manager`.`risk_control_has_requirement` (
  ...
  CONSTRAINT `fk_risk_control_has_requirement_requirement1`
    ...
    REFERENCES `validation_manager`.`requirement` (`id` , `minor_version`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `validation_manager`.`requirement_has_exception` (
  ...
  `requirement_mid_version` INT NOT NULL,
  `requirement_minor_version` INT NOT NULL,
  PRIMARY KEY (`vm_exception_id`, `vm_exception_reporter_id`, `requirement_id`, `requirement_major_version`, `requirement_mid_version`, `requirement_minor_version`),
  INDEX `fk_requirement_has_vm_exception_vm_exception1_idx` (`vm_exception_id` ASC, `vm_exception_reporter_id` ASC),
  INDEX `fk_requirement_has_exception_requirement1_idx` (`requirement_id` ASC, `requirement_major_version` ASC, `requirement_mid_version` ASC, `requirement_minor_version` ASC),
...
CREATE TABLE IF NOT EXISTS `validation_manager`.`requirement_has_requirement` (
  ...
  `requirement_mid_version` INT NOT NULL,
  `requirement_minor_version` INT NOT NULL,
  `requirement_id1` INT NOT NULL,
  `requirement_major_version1` INT NOT NULL,
  `requirement_mid_version1` INT NOT NULL,
  `requirement_minor_version1` INT NOT NULL,
  PRIMARY KEY (`requirement_id`, `requirement_major_version`, `requirement_mid_version`, `requirement_minor_version`, `requirement_id1`, `requirement_major_version1`, `requirement_mid_version1`, `requirement_minor_version1`),
  INDEX `fk_requirement_has_requirement_requirement2_idx` (`requirement_id1` ASC, `requirement_major_version1` ASC, `requirement_mid_version1` ASC, `requirement_minor_version1` ASC),
  INDEX `fk_requirement_has_requirement_requirement1_idx` (`requirement_id` ASC, `requirement_major_version` ASC, `requirement_mid_version` ASC, `requirement_minor_version` ASC),

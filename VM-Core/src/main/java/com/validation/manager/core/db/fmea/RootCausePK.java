...
public class RootCausePK implements Serializable {
    ...
    @NotNull
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "RootCauseGen")
    @TableGenerator(name = "RootCauseGen", table = "vm_id",
    ...
    public String toString() {
        return "com.validation.manager.core.db.fmea.RootCausePK[ id=" + id + ", rootCauseTypeId=" + rootCauseTypeId + " ]";
    }

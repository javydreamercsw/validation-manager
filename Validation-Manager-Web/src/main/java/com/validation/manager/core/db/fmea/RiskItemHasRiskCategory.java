...
public class RiskItemHasRiskCategory implements Serializable {
    ...
    public RiskItemHasRiskCategory(int riskitemFMEAid, int riskCategoryId) {
        this.riskItemHasRiskCategoryPK = new RiskItemHasRiskCategoryPK(riskCategoryId, riskitemFMEAid);
    }

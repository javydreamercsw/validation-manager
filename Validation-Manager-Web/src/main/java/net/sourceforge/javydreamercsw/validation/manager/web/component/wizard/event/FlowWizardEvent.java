...
/**
 * Base event for wizard progress notifications.
 */
public abstract class FlowWizardEvent implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private final FlowWizard source;

    protected FlowWizardEvent(FlowWizard source) {
        this.source = source;
    }

...
/**
 * Fired when a step is completed (advanced past).
 */
public class FlowWizardStepCompletionEvent extends FlowWizardEvent {

    private static final long serialVersionUID = 1L;

    private final FlowWizardStep step;

    public FlowWizardStepCompletionEvent(FlowWizard wizard, FlowWizardStep step) {
        super(wizard);
        this.step = step;
    }

    public FlowWizardStep getStep() {
        return step;
    }
}
